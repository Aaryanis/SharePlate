...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaBuilding, FaUserSecret } from 'react-icons/fa';
                  ...
                  <Form onSubmit={handleSubmit}>
                      ...
                      <Col md={6}>
                        <Form.Group className="mb-3">
                          ...
                          <Form.Control
                            ...
                            placeholder="Restaurant, Event Company, etc."
                          />
                          <Form.Control.Feedback type="invalid">
                            {errors.organization}
                          </Form.Control.Feedback>
                    ...
                    <Form.Group className="mb-3">
                      <Form.Check
                        ...
                        label={
                          <span>
                            <FaUserSecret className="me-2 text-success" />
                      ...
                      />
                      <Form.Text className="text-muted">
                        If checked, your name will not be visible to NGOs when you donate food
                      </Form.Text>
                    </Form.Group>
